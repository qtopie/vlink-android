...
extern void Java_com_github_shadowsocks_plugin_v2ray_VlinkVpnService_startVLinkNative(JNIEnv* env, jobject clazz, jint fd, jstring serverStr, jstring hostStr, jstring userAgentStr, jstring serviceNameStr, jstring tunAddrStr, jint tunMTU, jboolean verbose, jstring logPathStr);
